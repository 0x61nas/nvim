-- ============================================================================
-- CONSOLIDATED NEOVIM CONFIGURATION (init.lua)
-- Merges all configuration files, plugins, settings, keybindings, and autocommands
-- ============================================================================
...
local plugins = {
  ...
  --  Git source for nvim-cmp
  {
    ...
    opts = {
      ...
      indent = { enable = true },
      ensure_installed = {
        "rust", "bash", "c", "diff", "html", "javascript", "jsdoc", "json", "jsonc", "lua", "luadoc", "luap",
        "markdown", "markdown_inline", "nim", "python", "query", "regex", "toml", "tsx", "typescript", "vim",
        "nasm", "vimdoc", "xml", "yaml", "hurl", "nix", "zig", "asm", "jq", "just", "latex", "go", "gleam", "gitcommit",
        "gitignore", "dockerfile", "go", "kdl", "kotlin", "java", "make", "pony", "po", "printf", "sql", "typst", "http",
        "graphql", "earthfile", "editorconfig", "ssh_config", "tmux", "glsl", "hlsl", "ini", "udev", "llvm", "ispc", "inko",
        "disassembly", "diff", "haskell", "corn", "odin",
      },
      ...
      textobjects = {
        move = {
          enable = true,
          goto_next_start = { ["]f"] = "@function.outer", ["]c"] = "@class.outer" }, goto_next_end = { ["]F"] = "@function.outer", ["]C"] = "@class.outer" },
          goto_previous_start = {
            ["[f"] = "@function.outer",
            ["[c"] = "@class.outer",
          },
